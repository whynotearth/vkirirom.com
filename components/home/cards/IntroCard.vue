<template>
<nuxt-link v-bind:to="'/listing/' +place.slug" style="text-decoration:none;">
  <v-card :min-width="width" class="rounded-card pa-50"  hover>
    <v-img
      :src="place.image"
      aspect-ratio="1.5"
    >
    </v-img>
      <v-card-text class="pl-0 pr-3 description pt-2 pa-2" color="white">
